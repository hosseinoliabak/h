...
: Summary of IPv4 Versus IPv6 {#tbl-ipv4-vs-ipv6 tbl-colwidths="[20,40,40]"}
...
: Approaches to Enable/Transition to IPv6 for the Enterprise {#tbl-ipv6-transition-enterprise tbl-colwidths="[18,16,12,27,27]"}
...
**1. Which of the following IPv6 design approaches would allow a network to provide IPv6 access inbound or outbound at the enterprise Internet edge?**
...
: Approaches to Enable/Transition to IPv6 for the Service Provider {#tbl-ipv6-transition-sp tbl-colwidths="[35,15,50]"}
...
: Mechanisms to Support Coexistence of IPv4 and IPv6 {#tbl-ipv4-ipv6-coexistence tbl-colwidths="[15,18,22,45]"}
...
**1. Which of the following IPv6 mechanisms would allow for end-to-end IPv4 and IPv6 functionality?**
...
**1. Which of the following IPv6 mechanisms would allow network-to-network connectivity to transit IPv6 over IPv4-only devices without any additional control plane protocols?**
...
ABC Corp. is an international real-estate company headquartered in Singapore, with 116 remote sites across Asia, Australia, and Europe, as per @fig-abc-network.
...
The transition approach is illustrated in @fig-abc-ipv6.
...
: Top-Down QoS Design Approach Summary {#tbl-qos-top-down tbl-colwidths="[20,25,55]"}
...
@fig-qos-ds-domains illustrates the relationship between DS domains and boundary nodes.
...
In the second scenario, multiple DS domains belonging to a single administrative authority can be combined under one global DS region. Each DS domain in that region can have its own QoS provisioning standards, offering a more structured and tiered design for large-scale networks (@fig-qos-multitier).
...
Marking also establishes trust boundaries at the edge of the network — the point where markings such as CoS or DSCP begin to be accepted as set by the connected endpoint. Trust boundaries are classified into three primary models (@fig-qos-trust):
...
: Summary of QoS Classification and Marking Options {#tbl-qos-classification-marking tbl-colwidths="[15,45,40]"}
...
: Common QoS Queuing Mechanisms {#tbl-qos-queuing tbl-colwidths="[25,75]"}
...
Hierarchical QoS (HQoS) solves this by using a shaper at the parent policy to simulate backpressure, informing the router that congestion has occurred at the provisioned rate so that child QoS policies can take effect (@fig-hqos).
...
**1. Which of the following QoS queuing characteristics is an example of Weighted Fair Queuing?**
...
**1. Which of the following QoS queuing characteristics is an example of FIFO?**
...
**1. Which of the following QoS queuing characteristics is an example of Priority Queuing?**
...
**1. Which of the following QoS queuing characteristics is an example of LLQ?**
...
The difference between policing and shaping is illustrated in @fig-traffic-policing and @fig-traffic-shaping.

::: {#fig-traffic-policing}
```{=html}
<div style="text-align:center">
<svg xmlns:xlink="http://www.w3.org/1999/xlink" style="max-width:100%;max-height:300px;" viewBox="0 0 703.485 255.645" xmlns="http://www.w3.org/2000/svg" version="1.1">
 <metadata>
  <rdf:RDF xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
   <cc:Work>
    <dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage"/>
    <dc:date>2026-04-29T09:37:23.531759</dc:date>
...
" style="fill: none"/>
   ...
   <g id="line2d_1">
    <path d="M 26.685 228.96 
L 37.091446 33.660902 
L 37.639153 33.660902 
L 38.186861 36.970313 
L 39.282276 45.638671 
L 40.377692 56.515916 
L 42.020814 75.490535 
L 45.30706 114.822697 
L 46.950183 131.524315 
L 48.045599 140.761815 
L 49.141014 148.321331 
L 696.285 108 
" clip-path="url(#p83a89a82da)" style="fill: none; stroke-dasharray: 5.55,2.4; stroke-dashoffset: 0; stroke: #000000; stroke-width: 1.5"/>
   </g>
   <g id="patch_6">
    <path d="M 422.978878 228.96 
L 422.978878 7.2 
...
" style="fill: none; stroke: #4472c4; stroke-width: 3; stroke-linecap: round"/>
 ...
 <defs>
  <clipPath id="pf547225247">
   <rect x="26.685" y="7.2" width="273.306122" height="221.76"/>
  </clipPath>
  <clipPath id="p83a89a82da">
   <rect x="422.978878" y="7.2" width="273.306122" height="221.76"/>
  </clipPath>
 </defs>
</svg>
...
@tbl-12class-qos provides a generic 12-class QoS baseline model based on both the Cisco QoS Baseline and informational RFC 4594, offering common and unified traffic marking and profiling characteristics across single and multiple DS domains.
...
: Twelve-Class QoS Baseline Model Based on Cisco and RFC 4594 Baselines {#tbl-12class-qos tbl-colwidths="[20,12,8,25,35]"}
...
Network designers must adjust bandwidth allocation based on actual traffic flow requirements, security concerns, available bandwidth, and whether the link is LAN, WAN, or data center. The overall QoS design framework is summarized in @fig-qos-framework.
...
The enterprise edge represents the DS domain boundary where traffic must be mapped and profiled to align with the adjacent DS domain. For example, a 12-class enterprise model must be mapped to a 4-class SP model at the WAN edge router (CE) toward the SP edge (PE), as shown in @fig-qos-wan-edge.
...
VPN solutions add additional IP and ESP headers to each packet, increasing overhead and bandwidth consumption. For example, a G.711 VoIP RTP stream requiring 80 kbps at Layer 3 increases to ~112 kbps when sent over GRE encrypted with IPsec, which is
an almost 40% bandwidth increase to transport the encrypted VoIP call. Therefore,
bandwidth consumption with VPN is an essential point network designers need to consider,
because it will usually impact the overall supported number of simultaneous voice calls or
application sessions based on the actual available bandwidth.
...
This approach is based on bottom-up communication between management systems using protocols including NetFlow, syslog, and SNMP. In large networks, a failure in one area can impact multiple devices, each independently alerting the NMS and creating duplicate instances of the same problem. The multitiered architecture is shown in @fig-multitier-nm.
...
Yet Another Next Generation (YANG) is an IETF standard (RFC 6020) data modeling language used to describe data for network configuration protocols such as NETCONF and RESTCONF. YANG has a hierarchical configuration structure within data models, making it easy to read and reuse. It is extensible through augmentation and serves as a full, formal contract language with rich syntax and semantics. @lst-yang-example shows a simple YANG data model.

```{#lst-yang-example .yang lst-cap="YANG Data Model Example"}
module my-interface {
...
In most design situations, it will be best to leverage NETCONF for routers and switches and RESTCONF for controller northbound communication. @tbl-netconf-vs-restconf represents the different layers, highlighting NETCONF and RESTCONF characteristics at each layer.
...
: Layering Model for NETCONF vs RESTCONF {#tbl-netconf-vs-restconf tbl-colwidths="[20,40,40]"}

The operations listed in @tbl-netconf-vs-restconf are not an all-inclusive list of operations for both NETCONF and RESTCONF. @lst-restconf-operations maps the YANG model to corresponding RESTCONF HTTP operations.

```{#lst-restconf-operations .yang lst-cap="RESTCONF HTTP Operations Mapped to YANG Model"}
module my-interface {                    
...
**1. Which network management protocol would be used if you wanted XML encoding and messages encrypted with SSH?**
...
**1. Which network management protocol would be used for northbound controller communication leveraging JSON encoding while also leveraging HTTP for transport?**
...
**1. When consumers that leverage IaaS reach 100% resource capacity, what can be used to redirect the overflow of traffic to the public cloud, so there is no disruption to service?**
