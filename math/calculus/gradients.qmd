...
**Q1.** Given $f(x,y) = x^2 y + 3x^2$, find $\frac{\partial f}{\partial x}$.
...
**Q2.** Given $f(x,y) = xy^2 + 2x + 3y$, find the gradient $\nabla f(x,y)$.
...
**Q3.** Find the gradient of $f(x,y,z) = x^2 + 2xyz + z^2$.
...
**Q4.** Let $f(x,y) = x^2 + 2y^2 + 8y$. What is the minimum **value** of $f$?
...
## Optimization Example: The 2D Sauna
...
*Previous: [Partial Derivatives](partial-derivatives.qmd)*
