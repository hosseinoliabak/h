...
The lab uses the TV marketing dataset, which tracks TV advertising spend and the resulting sales. You can [download the dataset here](/media/tvmarketing.csv).
