...
**2. A linear transformation sends the unit square to the following parallelogram. What is the $2 \times 2$ matrix $A$ that produces this transformation?**
...
**6. When computing an inverse matrix via linear systems, what do the variables $a$, $b$, $c$, and $d$ represent?**
