...
description: "So far you've been working with systems of equations and matrices, solving them by elimination, reducing them to row echelon form, and running Gaussian..."
date: "2026-04-03"
difficulty: 2
order: 5
...
node_colors = ['#C8CED8', '#7ED4E6', '#7ED4E6', '#F49AC9']
...
**1. Calculate the norm $\|\mathbf{v}\|$ of the vector $\vec{v} = (1, -5, 2, 0, -3)$ and select the correct answer.**

::: {.callout-tip collapse="true"}
## Answer
$\|\mathbf{v}\| = \sqrt{1^2 + (-5)^2 + 2^2 + 0^2 + (-3)^2} = \sqrt{1 + 25 + 4 + 0 + 9} = \sqrt{39}$.
:::

---

**1. Which of the following vectors has the greatest norm?**

- $\begin{bmatrix} 1 \\ 2 \\ -3 \end{bmatrix}$, $\begin{bmatrix} 1 \\ 0 \\ -2 \\ 0 \\ -1 \end{bmatrix}$, $\begin{bmatrix} 2 \\ 2 \\ 2 \\ 2 \end{bmatrix}$, $\begin{bmatrix} 2 \\ 5 \end{bmatrix}$, $\begin{bmatrix} 0 \\ 0 \\ 0 \\ 0 \end{bmatrix}$

::: {.callout-tip collapse="true"}
## Answer
$\begin{bmatrix} 2 \\ 5 \end{bmatrix}$ with norm $\sqrt{4 + 25} = \sqrt{29} \approx 5.39$.

The others: $\sqrt{14} \approx 3.74$, $\sqrt{6} \approx 2.45$, $\sqrt{16} = 4$, and $0$.
:::
...
**1. Given the vectors $\vec{v} = (1, 0, 7)$ and $\vec{w} = (0, -1, 2)$, find the distance between them, $d(\vec{v}, \vec{w})$.**

::: {.callout-tip collapse="true"}
## Answer
$d(\vec{v}, \vec{w}) = \|\vec{v} - \vec{w}\| = \|(1, 1, 5)\| = \sqrt{1^2 + 1^2 + 5^2} = \sqrt{27}$.
:::

---

**1. You are given the points $P = (1, 0, -3)$ and $Q = (-1, 0, -3)$. The magnitude of the vector from $P$ to $Q$ is:**

::: {.callout-tip collapse="true"}
## Answer
The vector from $P$ to $Q$ is $Q - P = (-1 - 1, 0 - 0, -3 - (-3)) = (-2, 0, 0)$. Its magnitude is $\sqrt{(-2)^2 + 0^2 + 0^2} = 2$.
:::
...
ax.text(4.2, 4.1, r'$\mathbf{p}$', fontsize=12, ha='center', color='#CC7000')
...
**1. Select the correct statements pertaining to the dot product.**
...
- "The dot product of two vectors is always a scalar." (By definition, the dot product multiplies corresponding entries and sums them, producing a single number.)
- "The dot product of orthogonal vectors is always 0." (Two vectors are orthogonal if and only if their dot product is zero.)

The other two are false. The dot product of orthogonal vectors is 0, not 1. And the dot product is a scalar, not a vector, so it cannot be a diagonal of a parallelogram.
:::

---

**1. Calculate the dot product $\vec{a} \cdot \vec{b}$ where $\vec{a} = \begin{bmatrix} 3 \\ 7 \\ 1 \end{bmatrix}$ and $\vec{b} = \begin{bmatrix} 4 \\ 0 \\ 3 \end{bmatrix}$.**

::: {.callout-tip collapse="true"}
## Answer
$\vec{a} \cdot \vec{b} = 3(4) + 7(0) + 1(3) = 12 + 0 + 3 = 15$.
:::

---

**1. Calculate the dot product $\vec{w} \cdot \vec{z}$ where $\vec{w} = \begin{bmatrix} -9 \\ -1 \end{bmatrix}$ and $\vec{z} = \begin{bmatrix} -3 \\ -5 \end{bmatrix}$.**

::: {.callout-tip collapse="true"}
## Answer
$\vec{w} \cdot \vec{z} = (-9)(-3) + (-1)(-5) = 27 + 5 = 32$.
:::
