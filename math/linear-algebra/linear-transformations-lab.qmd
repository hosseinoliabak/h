...
An image in the plane is just a collection of points. We store it as a $2 \times n$ matrix where each column is a point $\begin{bmatrix}x\\y\end{bmatrix}$. The file is too large to host on this site, so download it from Google Drive: [image.txt](https://drive.google.com/file/d/1gGLMkRpjEE2NSv3a2uzym5fQqLXB46ga/view?usp=sharing) (16 MB).
