...
**2. If $\det(M) = 20$ and $\det(N) = 10$ (where $M$ and $N$ have the same size), what is $\det(M \cdot N)$ and $\det(N^{-1})$?**
...
**3. The product of a singular and a non-singular matrix (in any order) is:**
...
**5. Find the determinant of the following matrix:**
...
**6. What geometric aspect of a linear transformation does the determinant quantify?**
...
**7. Let $T$ be a linear transformation in the plane represented by the matrix $\begin{bmatrix} 1 & 0 \\ 2 & 3 \end{bmatrix}$. The rank of $T$ is:**
...
**8. A linear transformation $T$ maps the vectors as follows: $T(1,0) = (3,1)$ and $T(0,1) = (2,5)$. The area of the parallelogram spanned by transforming $(1,0)$ and $(0,1)$ is:**
...
**10. Let $M$ and $N$ be two square matrices with the same size. Which of the following statements are true?**
...
**11. Let $M = \begin{bmatrix} 0 & 0 & 1 \\ 2 & 2 & 1 \\ 1 & 0 & 0 \end{bmatrix}$. Compute $\det(M^{-1})$.**
