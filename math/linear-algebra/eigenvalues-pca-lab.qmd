...
Now let's apply PCA to reduce the dimensionality of image data, the classic [data compression](/machine-learning/unsupervised-learning/principal-components-analysis.qmd#advice-for-applying-pca) use of PCA from the machine learning notes. We'll work with 55 grayscale cat photos (64×64 pixels each).

### Load the Images

The 55 cat photos are available as a single archive, [cats.zip](/media/cats.zip) (172 KB). Extract it so the images sit in a `cats/` folder next to your notebook.
