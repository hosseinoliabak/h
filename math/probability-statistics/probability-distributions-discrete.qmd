...
**16. You roll a six-sided die 20 times and want to find the probability that the number 4 appears exactly 7 times. Which equation correctly represents this scenario?**
...
**17. A taxi cab service analyzes the number of passengers in its daily rides. The observed probabilities are: $P(X=0) = 0.10$, $P(X=1) = 0.25$, $P(X=2) = 0.25$, $P(X=3) = 0.15$, $P(X=4) = 0.15$, $P(X=5) = 0.05$, $P(X=6) = 0.05$. What is the probability that a randomly selected taxi ride will have less than or equal to 3 passengers?**
