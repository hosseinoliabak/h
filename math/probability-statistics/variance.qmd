...
**17. Consider four sets of samples. Which one has the smallest variance?**
...
**18. Consider the following independent random variables: $X \sim N(3, 1^2)$ and $Y \sim N(2, 2^2)$. Then $Z = X + Y \sim N(\mu, \sigma^2)$, where $\mu$ and $\sigma$ are equal to:**

a. $\mu = \sqrt{5},\; \sigma = \sqrt{3}$
b. $\mu = 5,\; \sigma = \sqrt{5}$
c. $\mu = 5,\; \sigma = \sqrt{3}$
d. $\mu = 5,\; \sigma = 5$
