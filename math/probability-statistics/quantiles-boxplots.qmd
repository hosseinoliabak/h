...
**2. What is the difference between the 25% quantile and the 75% quantile?**
...
**3. For a continuous distribution, what does the 90% quantile represent geometrically?**
...
**4. A dataset has $Q_1 = 10$, $Q_2 = 15$, and $Q_3 = 30$. What can you say about the shape of this data?**
...
**5. What five statistics does a box plot display?**
...
**6. How do you determine the whisker length in a box plot?**
...
**7. In our 12-sample dataset, $Q_2 - Q_1 = 9.45$ and $Q_3 - Q_2 = 25.15$. What does this tell you?**
...
**8. What does it mean when a data point appears as a dot beyond the whisker?**
...
**9. What are two problems with using a histogram as an estimate of the PDF?**
...
**10. In KDE, what is the "kernel" and what role does it play?**
...
**11. What happens to the KDE if you choose a very small bandwidth?**
...
**12. Why does the KDE have total area equal to 1?**
...
**13. What does a violin plot show that a box plot alone does not?**
...
**14. Why is checking for normality important in data science?**
...
**15. In a QQ plot, what does it mean when the points fall along the diagonal line?**
...
**16. The QQ plot for the newspaper budget curves upward on the right side. What does this indicate?**
...
**17. Consider the following box plot for test scores of two classes, A and B. Class A has a box from about 68 to 90 with median around 75. Class B has a box from about 78 to 92 with median around 85, and one outlier below the whisker. Which statements are true?**
...
**18. Consider the following QQ plot where points closely follow the diagonal line with only minor deviations at the extreme tails. Which statement is true?**
