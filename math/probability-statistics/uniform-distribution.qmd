...
**2. For $X \sim \text{Uniform}(2, 8)$, what is the height of the PDF?**
...
**3. For $X \sim \text{Uniform}(0, 5)$, what is $P(1 < X < 3)$?**
...
**4. Why does the height of the uniform PDF increase when the interval $[a, b]$ gets smaller?**
