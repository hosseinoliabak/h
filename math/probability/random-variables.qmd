...
.dnd-drop.drag-over { border-color: var(--site-accent); background: var(--site-accent-soft); }
...
.dnd-check-btn:hover { background: var(--site-accent); color: var(--site-accent-contrast); }
