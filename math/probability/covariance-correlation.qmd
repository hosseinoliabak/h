...
Ignoring the signs, 17 is much larger than 7.45. Does that mean the relationship between age and height is "stronger" than between age and naps? Not necessarily. The covariance depends on the scale of the variables. Heights are measured in tens (50-68), while naps are single digits (0-8). The larger numbers in heights naturally produce a larger covariance.
...
Despite the large difference in raw covariance (17 vs. 7.45), the correlation coefficients have similar magnitudes (~0.89 vs. ~0.89). Both age-height and age-naps have strong linear relationships of similar strength, just in opposite directions. Age-grades has a correlation near zero, confirming no linear trend.
