...
description: "In this lab you will use the World Happiness Report dataset to explore linear regression. You will fit models to predict a country's happiness score..."
date: "2026-06-27"
difficulty: 2
order: 7
categories: [statistics, lab]
fig-format: png   # dense regression scatter over the full dataset runs ~5.7 MB as SVG; keep raster
---
...
The World Happiness Report surveys people in different countries about their well-being. Each row in the dataset represents one country in one year. The "life ladder" column is the happiness score (higher = happier). The other columns are possible explanations for why some countries are happier than others. You can [download the dataset here](/media/world_happiness.csv), the same file used in the [intro to pandas lab](/math/probability/lab-intro-to-pandas.qmd).
