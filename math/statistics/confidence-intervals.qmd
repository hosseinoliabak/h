...
description: "You have seen how to take samples from a population and compute a sample mean to estimate an unknown population mean . You know that good sampling..."
date: "2026-07-01"
difficulty: 3
order: 8
...
//| echo: false
html`<style>
.ci-tool { border: 2px solid var(--site-surface-border); border-radius: 8px; padding: 20px; margin: 1em 0; background: var(--site-surface); font-family: 'PT Sans', sans-serif; }
...
.ci-tool button { padding: 7px 16px; border: 1px solid var(--site-accent); background: transparent; color: var(--site-accent); border-radius: 4px; font-size: 0.9em; font-weight: 600; cursor: pointer; }
.ci-tool button:hover { background: var(--site-accent); color: var(--site-accent-contrast); }
...
viewof ciControls = {
  const div = html`<div class="ci-tool">
    ...
    <div class="row">
      ...
      <button id="ci-clear" style="border-color:var(--bs-tertiary-color,#999);color:var(--bs-secondary-color,#666);">Refresh</button>
    </div>
  </div>`;
