...
description: "So far, all the hypothesis testing you have done involves a single sample from one population. But what happens when you want to compare two different..."
date: "2026-07-03"
difficulty: 4
order: 11
...
<thead>
<tr style="background:var(--site-accent); color:var(--site-accent-contrast);">
