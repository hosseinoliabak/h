...
description: "In the previous lessons, you learned how to compute sample statistics (mean, proportion, variance) and how the Law of Large Numbers and Central Limit..."
date: "2026-06-29"
difficulty: 3
order: 4
...
a. $N(1, 0) = N(1, 0^2)$
b. $N(1.25, 0.5) = N(1.12, 0.71^2)$
c. $N(0, 1) = N(0, 1^2)$
d. $N(0.5, 1.25) = N(0.5, 1.12^2)$
...
html`<style>
.mle-tool {
  border: 2px solid var(--site-surface-border); border-radius: 8px; padding: 20px; margin: 1em 0;
  background: var(--site-surface); font-family: 'PT Sans', sans-serif;
}
...
.mle-tool button:hover { background: var(--site-accent); color: var(--site-accent-contrast); }
